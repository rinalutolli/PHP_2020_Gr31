...
if(isset($_GET['id'])){ 
$id = $_GET['id'];
$sql = 'SELECT * FROM userss where id='.$_GET['id'];
...
if(isset($_POST['edit'])){ 
 ...
 $name = $_POST['name'];
  ...
  $c_password = $_POST['c_password'];
	...
	$sql = "UPDATE userss  set name = '$name', surname ='$surname', email ='$email', birthday = '$birthday', email ='$email', password = md5('$password'), c_password =md5('$c_password') where id =$id";
