...
echo Emri;
?> </h1></h1>
   <h3 style="text-transform: uppercase;"><?php $faqet = array("ALL THE LATEST NEWS & INFORMATIONS IN THE WORLD", "FASHION", "SPORTS"); echo $faqet[2];?></h3>
