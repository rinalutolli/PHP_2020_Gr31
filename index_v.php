...
?>
    <span style="color:white;float: right;"><b>
       <?php
if($_SESSION["lemail"]) {
?>
Welcome <?php
  ...
  $vargu = explode("@",$email);
  echo ucfirst($vargu[0]);?>! <a href="logout.php" title="Logout" style="background-color: white;border-radius: 10px; color:black;padding:10px; ">Logout.</a>
<?php
}
?></b>
<?php
if(!$_SESSION["lemail"]) {
?>
You are not logged in. Click here to <a href="logout.php" tite="Logout">Login.</a>
<?php
}
?>
</span>
